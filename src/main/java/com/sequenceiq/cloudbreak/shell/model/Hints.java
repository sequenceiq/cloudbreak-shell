...
public enum Hints {
    ...
    SELECT_SECURITY_GROUP("Use 'security group list' to list the available security groups, a group could be selected by 'security group select'"
            + " or created by 'security group create' command"),
